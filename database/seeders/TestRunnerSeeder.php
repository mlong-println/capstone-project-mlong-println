    ...
    public function run(): void
    {
        ...
        foreach ($runners as $runnerData) {
            ...
            Profile::create([
                ...
                'current_weekly_distance' => $runnerData['current_weekly_distance'],
                'total_runs' => $runnerData['total_runs'],
                'total_distance' => $runnerData['total_distance'],
                'pr_5k_minutes' => $runnerData['pr_5k_minutes'] ?? null,
                'pr_10k_minutes' => $runnerData['pr_10k_minutes'] ?? null,
                'pr_half_marathon_minutes' => $runnerData['pr_half_marathon_minutes'] ?? null,
                'pr_full_marathon_minutes' => $runnerData['pr_full_marathon_minutes'] ?? null,
                'profile_public' => true,
                'show_stats' => true,
            ]);
        }
