...
interface SafetyAlertsIndexProps {
    alerts: PaginatedAlerts;
}

export default function Index({ alerts }: SafetyAlertsIndexProps) {
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="mt-1 text-sm text-blue-700">
                                            Report route conditions, hazards, closures, and other safety concerns to help fellow runners stay informed.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {alerts.data.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        All routes are clear! Be the first to report any issues.
                                    </p>
                                </div>
                            ) : (
